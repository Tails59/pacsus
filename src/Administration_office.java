...
public class Administration_office extends JFrame implements Observer, ActionListener {
    ...
    public Administration_office(System_status status, Vehicle_list veh, Permit_list permits) {
		...
		JLabel lblRegistrationNumberAdd = new JLabel("Registration Number:");
		GridBagConstraints gbc_lblRegistrationNumberAdd = new GridBagConstraints();
		gbc_lblRegistrationNumberAdd.insets = new Insets(0, 0, 5, 5);
		gbc_lblRegistrationNumberAdd.gridx = 1;
		gbc_lblRegistrationNumberAdd.gridy = 1;
		addPermit.add(lblRegistrationNumberAdd, gbc_lblRegistrationNumberAdd);
		...
		JComboBox cb_PermitTypeAdd = new JComboBox();
		...
		JButton sumbitBtnAdd= new JButton("Submit");
		sumbitBtnAdd.addActionListener(this);
		GridBagConstraints gbc_sumbitBtnAdd = new GridBagConstraints();
		gbc_sumbitBtnAdd.fill = GridBagConstraints.BOTH;
		gbc_sumbitBtnAdd.insets = new Insets(0, 0, 0, 5);
		gbc_sumbitBtnAdd.gridx = 1;
		gbc_sumbitBtnAdd.gridy = 9;
		addPermit.add(sumbitBtnAdd, gbc_sumbitBtnAdd);
